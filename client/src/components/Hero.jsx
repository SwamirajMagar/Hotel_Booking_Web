...
-
        //add destination to serachedcities max 3 
    ...
    return(
        <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover h-screen'>
            ...
            <p className='max-w-130 mt-2 text-sm md:text-base'>"Discover comfort and luxury with seamless hotel booking, tailored for your perfect stay. Start your jorney Today"</p>
