...
const Footer = () => {
  return (
        <div className='bg-[#93F93C] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    <img src={assets.logo} alt="logo" className='mb-4 h-8 md:h-9 invert opacity-80' />
                    <p className='text-sm'>
                        Discovers the worlds  most extraordinary place to stay, from hotels 
                    </p>
                ...
                <div>
                    <p className='font-playfair text-lg text-gray-800'>HOTELS</p>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()}swamirajmagar8@gmail.com All rights reserved.</p>
